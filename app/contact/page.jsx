    ...
    <div>
      ...
      <div>
        <div className="flex justify-center items-center gap-5  md:justify-around flex-wrap flex-col md:flex-row p-5">
          <div class=" md:w-1/2 md:h-96 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 d items-center flex flex-col gap-5 justify-center">
        ...
        <div className="flex flex-col justify-cente md:items-center m-5 gap-5">
          <div className="md:w-1/2">
            ...
            <h5 className="font-bold text-lg text-[#1D24CA] uppercase">MARTERU Branch</h5>
            <p className="text-2xl font-lg"> CFI MISSION CHURCH, D.No 5-2, VANAMPALLI,  MARTERU <br /> WEST
              GODAVARI DIST, ANDHRA PRADESH. PINCODE - 534 122</p>
            <iframe
            ...
            ></iframe>
            <h5 className="font-bold text-lg text-[#1D24CA] pt-5  uppercase">PALAKOLLU Branch</h5>
            <p className="text-2xl font-lg">CFI MISSION CHURCH, PARVATHI NAGAR, CHERUVUPETA PALAKOLLU 
            <br />
            WEST GODAVARI DIST, ANDHRA PRADESH. PINCODE - 534 260</p>
            <iframe
