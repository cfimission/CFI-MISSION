  ...
  return (
    <div className="">
      ...
      <div className="flex justify-center m-5  ">
        <Link href="/about/sureshkumar" className=" border-b-2 ">
          <h1 className=" text-lg p-2 md:text-xl font-bold">About Pastor, </h1>
        </Link>

        <Link href="/about/cfimission" className=" border-b-2 border-cyan-600">
              ...
              <div className="flex gap-x-3 ">
                <div className="w-16 text-end">
                  <div className="w-20  text-center">
                    <span className="text-lg font-bold text-black dark:text-gray-400 break-words">
                      {item.dayabout}
                    </span>
                  </div>
